...
#| fig.cap = "Histogram of Distribution 1"
hist(random_numbers1, col = "blue")
```

# Distribution 2

```{r, random-numbers2-histogram}
#| fig.cap = "Histogram of Distribution 2"
hist(random_numbers2, col = "lightpink")
```

# Distribution 3

```{r, random-numbers3-histogram}
#| fig.cap = "Histogram of Distribution 3"
hist(random_numbers3, col = "purple3")
```